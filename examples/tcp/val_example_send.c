...
{
    fprintf(stderr,
            "Usage: %s [--mtu N] [--policy NAME|ID] [--log-level L] [--log-file PATH] <host> <port> <file1> [file2 ...>\n"
...
int main(int argc, char **argv)
{
    ...
    val_resume_policy_t policy = VAL_RESUME_POLICY_NONE; // leave legacy behavior unless specified
